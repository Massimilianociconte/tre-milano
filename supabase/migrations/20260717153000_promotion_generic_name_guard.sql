-- Le insegne amministrative generiche (es. "PASTICCERIA") non identificano
-- un locale reale: la promozione le esclude. I 124 record gia' promossi con
-- nome generico sono stati riportati a draft/non pubblicati il 17/07/2026.
